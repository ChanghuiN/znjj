package com.hchstudio.znjj.net;
...
public class HttpClient<T> {
    ...
    public static HttpClient getInstence(Builder builder) {
        if (mHttpClient == null) {
        ...
        mHttpClient.url = builder.url;
        mHttpClient.method = builder.method;
        mHttpClient.type = builder.type;
        mHttpClient.requestProperty = builder.requestProperty;
        mHttpClient.params = builder.params;
        mHttpClient.Charset = builder.Charset;
        return mHttpClient;
    }
    ...
    public static class Builder<T> {
        ...
        public HttpClient builder() {
            return HttpClient.getInstence(this);
        }
    }
